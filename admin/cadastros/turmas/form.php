    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate action="form.php<?= $id ? "?id={$id}" : '' ?>"
                      method="POST">
                    <input type="hidden" name="id" value="<?= $id ?>">

                    <div class="form-group mt-3">
                        <label for="turma_numero">Número</label>
                        <input type="text" class="form-control" id="turma_numero" name="turma_numero"
                               value="<?= $turma->turma_numero ?>" required placeholder="" required>
                    </div>
