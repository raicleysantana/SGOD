                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?= Config::$baseUrl ?>/admin/cadastros/turmas/turmas.php">Turmas</a></li>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <form action="form_turma.php<?= $id ? "?id={$id}" : '' ?>" method="POST">
                            ...
                            <div class="form-group mt-3">
                                ...
                                >
                                    ...
                                    <?php foreach (Utils::getSituacao() as $key => $situacao) { ?>
                                        <option
                                                value="<?= $key ?>"
                                            <?= ($id and $key == $turma->turma_situacao) ? 'selected' : '' ?>
                                        ><?= $situacao ?></option>
                                    <?php } ?>
                                </select>
                            </div>
