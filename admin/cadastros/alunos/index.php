            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-row justify-content-end mb-3">
                        <a href="<?= Config::$baseUrl ?>/admin/cadastros/alunos/form.php"
                    ...
                    <div class="row">
                        <table class="table datatable">
                            ...
                            <tr>
                                ...
                                <th scope="col" width="15%">Situação</th>
                            ...
                            foreach ($alunos as $aluno) :
                                ...
                                <tr id="turma-<?= $aluno->alu_id ?>">
                                    ...
                                    <td>
                                        <a href="<?= Config::$baseUrl ?>/admin/cadastros/alunos/visualizar.php?id=<?= $aluno->alu_id ?>"
                                           data-toggle="tooltip" data-placement="top" title=""
                                           data-bs-original-title="Visualizar">
                                            <i class="mdi mdi-eye me-2"></i>
                                        </a>
                                        <a href="<?= Config::$baseUrl ?>/admin/cadastros/alunos/form.php?id=<?= $aluno->alu_id ?>"
                                           data-toggle="tooltip" data-placement="top" title=""
                                           data-bs-original-title="Alterar">
                                            <i class="mdi mdi-grease-pencil me-2 text-warning"></i>
                                        </a>

                                        <a class="excluir" href="#" data-toggle="tooltip" data-placement="top" title=""
                                           data-id="<?= $aluno->alu_id; ?>" data-bs-original-title="Excluir">
