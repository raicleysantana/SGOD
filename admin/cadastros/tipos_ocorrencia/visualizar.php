...
$title = "Tipos de Ocorrências - Visualizar";
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?= Config::$baseUrl ?>/admin/cadastros/tipos_ocorrencia/index.php">Tipos de Ocorrências</a>
                            </li>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-9"><?= $d->tpo_nome; ?></div>
                </div>
                <div class="row">
                    <div class="col-md-3">Situação</div>
                    <div class="col-md-9"><?= Utils::situacao($d->tpo_situacao); ?></div>
                </div>
            </div>
        </div>
    </div>
