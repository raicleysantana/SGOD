...
$title = "Participantes - Visualizar";
...
$query = "SELECT * FROM participantes "
    . "LEFT JOIN cargos ON cargos.cgo_id = participantes.cgo_id "
    . "WHERE part_id = '{$id}'";
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-9"><?= $d->part_nome; ?></div>
                </div>
                <div class="row">
                    <div class="col-md-3">E-Mail</div>
                    <div class="col-md-9"><?= $d->part_email; ?></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9"><?= Utils::situacao($d->part_situacao); ?></div>
                </div>
            </div>
        </div>
    </div>
