        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="pt-4">
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= Config::$baseUrl ?>/admin" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="<?= Config::$baseUrl; ?>/admin/cadastros/participantes/index.php" class="sidebar-link">
                                <i class="mdi mdi-note-outline"></i>
                        ...
                        <li class="sidebar-item">
                            <a href="<?= Config::$baseUrl; ?>/admin/cadastros/tipos_ocorrencia/index.php" class="sidebar-link">
                                <i class="mdi mdi-note-outline"></i>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="tables.html" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu">Relatórios</span></a>
                </li>
